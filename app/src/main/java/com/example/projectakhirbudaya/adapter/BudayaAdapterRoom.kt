...
class BudayaAdapterRoom(private var postList: List<BudayaEntity>, private val budayaViewModel: BudayaViewModel) :
    ...
    class BudayaViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        //btn
        val btnAksi: LinearLayout = itemView.findViewById(R.id.btn_aksi)
    }
